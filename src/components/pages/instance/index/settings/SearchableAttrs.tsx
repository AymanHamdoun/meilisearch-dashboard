...
export const SearchableAttrs = () => {
    ...
    return <div>
        <DocHeader
            ...
            description={"The complete list of attributes that will be used for searching. Order matters — attributes listed first have higher search priority. Default value: ['*']"}
