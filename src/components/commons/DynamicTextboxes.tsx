...
const DynamicTextBoxes: React.FC<DynamicTextBoxesProps> = ({ label, initialTextboxValues }) => {
    ...
    return (
        <div>
            <div className="flex flex-row justify-between mb-3">
                ...
                <button className="border border-gray-200 rounded-sm py-1 px-3 hover:bg-primary hover:text-white font-semibold transition-all ease-in-out" onClick={handleAddTextbox}>+</button>
            </div>
