...
const Navbar = () => {
    return (
        <nav className="w-full bg-transparent border-b border-b-gray-200">
            <div className="px-3 py-5 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-start rtl:justify-end">
                        <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
...
const IndexDropdown = () => {
    ...
    if (!(["/instance/index"].includes(location.pathname))) {
        return <></>;
    }

    const changeSelectedIndex = (indexName: string) => {
    ...
    return (
        <div className="flex flex-row gap-3 items-center">
            ...
            <select name="meili_index"
                ...
                onChange={(e) => changeSelectedIndex(e.target.value)}
            >
