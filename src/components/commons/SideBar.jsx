...
const sideBarLinks = [
    ...
    {
        key: "s-5", label: "Settings", link: "#", icon: IndexIcon, children: [
            { key: "s-6", label: "API Keys", link: "/instance/keys", icon: IndexIcon, children: [] },
            { key: "s-7", label: "Experimental Features", link: "/instance/experimental", icon: IndexIcon, children: [] },
        ]
    },
]
