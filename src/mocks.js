...
const meiliAPIsToMock = {
    ...
    '/indexes/.*/documents/.*$': {"aliases":[],"cast":["christian bale","christopher nolan","cillian murphy","gary oldman","katie holmes","liam neeson","michael caine"],"cast_ar":["غاري أولدمان","غاري اولدمان","كريستوفر نولان","كريستيان بيل","كيتي هولمز","كيليان مورفي","ليام نيسون","مايكل كاين"],"genres":["Action","Fantasy"],"genres_ar":["أكشن","خيالي"],"title":"Batman Begins","title_ar":"باتمان بيغنز","status":1,"content_popularity":100,"order":1,"objectID":"22886"},
    '/indexes/.*/settings': {"displayedAttributes":["*"],"searchableAttributes":["*"],"filterableAttributes":[],"sortableAttributes":[],"rankingRules":["words","typo","proximity","attribute","sort","exactness"],"stopWords":[],"nonSeparatorTokens":[],"separatorTokens":[],"dictionary":[],"synonyms":{},"distinctAttribute":null,"proximityPrecision":"byWord","typoTolerance":{"enabled":true,"minWordSizeForTypos":{"oneTypo":5,"twoTypos":9},"disableOnWords":[],"disableOnAttributes":[]},"faceting":{"maxValuesPerFacet":100,"sortFacetValuesBy":{"*":"alpha"}},"pagination":{"maxTotalHits":1000},"searchCutoffMs":null,"localizedAttributes":null},
